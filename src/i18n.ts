...
const resources = {
  zh: {
    common: {
      ...
      notFoundBody: '请选择 Week 01–06，或返回最新已发布的学习页。',
  ...
  en: {
    common: {
      ...
      notFoundBody: 'Choose Week 01–06 or return to the latest published study guide.',
